...
## merge segments that are separated by 500bp (caron) or 1000bp (kapranov) or less while subtracting all the cds again incase you merged over some tiny coding exons
...
## 2021 update
## need to subtract after merging to get rid of regions that were joined across small tiny little exons
