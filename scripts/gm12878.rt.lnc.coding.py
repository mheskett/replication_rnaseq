...
df_normalized_logr_hap2["std_dev"] = df_normalized_logr_hap2.filter(like="gm12878",axis=1).std(axis="columns")
...
abs_diff_of_hap_means = abs(df_normalized_logr_hap1.filter(like="gm12878",axis=1).mean(axis="columns") - df_normalized_logr_hap2.filter(like="gm12878",axis=1).mean(axis="columns"))
