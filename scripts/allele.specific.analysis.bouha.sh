...
bcftools mpileup -R /home/groups/Spellmandata/heskett/replication.rnaseq/scripts/bouhassira.3.2.aligned.haplotypes.final.sorted.het.bed \
...
tail -n +2 $out_dir$filename.table | awk 'OFS="\t"{print $1,$2-1,$2,$3,$4,$5}' |
  bedtools intersect -a stdin -b /home/groups/Spellmandata/heskett/replication.rnaseq/scripts/bouhassira.3.2.aligned.haplotypes.final.sorted.het.bed -wa -wb > $out_dir$filename.allele.counts.bed
