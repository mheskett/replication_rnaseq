...
df = pd.read_csv("ucsc.mm39.genes.txt",sep="\t",
	names=["chrom","strand","start","stop","score","gene"])
###chrom  strand  txStart txEnd   score   name2
...
df_final.to_csv("ucsc.refseq.mm39.txn.whole.gene.bed",sep="\t",header=None,index=None)
os.system("sort -k1,1 -k2,2n ucsc.refseq.mm39.txn.whole.gene.bed > ucsc.refseq.mm39.txn.whole.gene.sorted.bed")