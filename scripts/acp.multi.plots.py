...
chromosomes = ["chr1","chr2","chr3","chr4","chr5","chr6","chr7","chr8","chr9","chr10","chr11","chr12",
                "chr13","chr14","chr16","chr17","chr18","chr19","chr20","chr21","chr22"]
...
repli_df=repli_df[repli_df["chrom"]!="chr15"]
#####
####
###
# print(repli_df)
...
## methinks theres a bug somewhere in the SD plotting
for chrom in chromosomes:
    ...
    plt.savefig("acp6.all.clones.vert.alleles."+chrom+".png",
        dpi=400,transparent=False, bbox_inches='tight', pad_inches = 0)
    plt.close()
repli_df.to_csv("acp6.all.clones.txt",sep="\t")
...
for chrom in chromosomes:
    plt.rc('xtick', labelsize=5) 
    plt.rc('ytick', labelsize=3) 
    f, ax = plt.subplots(5,1,figsize=(30,3),sharex=False,
    ...
    plt.savefig("acp6.all.clones.avg.asrt.alleles."+chrom+".png",
        dpi=400,transparent=False, bbox_inches='tight', pad_inches = 0)
    plt.close()
