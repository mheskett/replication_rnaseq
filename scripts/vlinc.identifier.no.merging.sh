...
samtools view -b -f 83 $out_dir$filename.mq30.bam > $out_dir$filename.fwd2.bam
...
## get minus strand
samtools view -b -f 147 $out_dir$filename.mq30.bam > $out_dir$filename.rev1.bam
samtools index $out_dir$filename.rev1.bam

samtools view -b -f 67 -F 16 $out_dir$filename.mq30.bam > $out_dir$filename.rev2.bam
